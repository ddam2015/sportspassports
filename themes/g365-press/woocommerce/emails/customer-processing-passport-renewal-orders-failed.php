  ...
  <section class="">
    <div class="contain-middle">
      <div class="passport-green--text">
        <h2 id="thank-you-text">This email is to inform you that the renewal payment for The Passport subscription failed to process. It is mandatory for all players participating in Grassroots365 events, EBC, Scholastic Series, The Stage Circuit, Breakthrough Circuit, Hype Her Hoops, or California Live to unlock their Passport. </h2>
        <h2 id="thank-you-text" class="renewal-title">To update your payment information and resubmit payment, please use the link <a href="https://sportspassports.com/account/subscriptions/">HERE</a>.</h2>
        <h2>If you are experiencing any issues, or have any questions, please contact our team at <a href="mailto: customersuccess@sportspassports.com">customersuccess@sportspassports.com</a>. Thank you.</h2>
      </div>
