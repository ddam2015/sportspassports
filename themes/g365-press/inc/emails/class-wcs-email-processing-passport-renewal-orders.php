 ...
 * @extends WC_Email
 */
class WCS_Email_Processing_Passport_Renewal_Orders extends WC_Email_Customer_Processing_Order {
	...
	function __construct() {
		...
		$this->id             = 'customer_processing_passport_renewal_orders';
		$this->title          = __( 'Processing Passport Renewal order', 'woocommerce-subscriptions' );
		...
		$this->subject        = __( 'Your Passport renewal order receipt from {order_date}', 'woocommerce-subscriptions' );

		$this->template_html  = 'emails/customer-processing-passport-renewal-orders.php';
		$this->template_plain = 'emails/plain/customer-processing-passport-renewal-orders.php';
...
//       $product_id = array(77489);  
	...
	function get_subject() {
		return apply_filters( 'woocommerce_subscriptions_email_subject_customer_processing_passport_renewal_order', parent::get_subject(), $this->object );
	}
