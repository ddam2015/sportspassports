...
//             'player_profiles' => [
//                 'host'              => 'localhost',
//                 'database'          => 'g365-press-wp-NnrH21kG',
//                 'username'          => 'YmUMylbrOPHa',
//                 'pass'              => 'dGIUbHRyuTgyLzRe',
...
//             ],
            'dataSources'           => [
            'player_profiles' => [
                'host'              => 'db-g365-do-user-1744987-0.b.db.ondigitalocean.com:25060',
                'database'          => 'spp',
                'username'          => 'doadmin',
                'pass'              => 'AVNS_KxVuEbdOgjNws4MLVxb',
                'table'             => 'wp_54ab678738_g365_players',
                // specify the name of search columns
                'searchColumns'      => ['name'],
                // specify order by column. This is optional
...
//                   'verified'  => '(0,1,2)'
            ...
            'pl_ev' => [
                ...
                'orderBy'            => 'name',
                'orderDirection'     => '',
                'filterResult'       => ['id','name','city','state','access','first_name','last_name', 'access'],
                'comparisonOperator' => 'LIKE',
                'searchPattern'      => '*q*',
                'caseSensitive'      => false,
                'maxResult'          => 20,
