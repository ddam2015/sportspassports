...
//     $name = htmlspecialchars($row['name']);
    $html .= '<tr data-href="/wp-admin/admin.php?page=admin_data_team_ev&event_id=' . $id . '"><td><a class="button g365-button expanded no-margin-bottom"><span>' . $name . '</span>' . '</a></td></tr>';
  }
} else {
  // No result
