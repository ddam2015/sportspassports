...
if (!empty($rows)) {
  foreach ($rows as $row) {
    ...
    $html .= '<tr data-name="' . $name . '" data-href="/wp-admin/admin.php?page=admin_all_tournament&event_id=' . $id . '&player_id='. $id .'"><td><div class="button g365-button expanded no-margin-bottom">' . $name . $location_info . " - " . $id . '</div></td></tr>'; 
  }
} else {
  // No result
