...
if (!empty($rows)) {
  foreach ($rows as $row) {
    ...
    $html .= '<tr onClick="pass_pl_id(this)" data-pl-id="'.$id.'" data-pl-name="'.$name.'"><td><a class="button g365-button expanded no-margin-bottom"><span>' . $name . $location_info . '</span>' . '</a></td></tr>';
  }
} else {
  // No result
