...
//     $country = htmlspecialchars($row['country']);
    ...
    $location_info .= '</span>';
    $html .= '<tr data-g365_presets=\'{"name":"' . $name_raw .  '}\' data-g365_id="' . $row['id'] . '" data-g365_name="' . $name_raw . '"><td><a class="button g365-button expanded no-margin-bottom"><span>' . $name . '</span>' . $location_info . '</a></td></tr>';
  }
} else {
  // No result
  ...
  $html .= "<tr><td>There is no result for \"{$query}\"<br><a class=\"button g365-button no-margin-bottom g365_add_button\">add school +</a></tr></td>";
}
