...
//     $nickname = htmlspecialchars($row['nickname']);
    ...
    $html .= '<tr data-href="/wp-admin/admin.php?page=admin_data_photo_verif&type=assigned&pl_id=' . $id . '"><td><a class="button g365-button expanded no-margin-bottom"><span>' . $name .'</span>' . '</a></td></tr>';
  }
} else {
  // No result
